...
public class ApplicationService {
    ...
    public ApplicationDto getApplicationById(int id) {
        log.debug("ApplicationService.getApplicationById()");
    ...
    public List<ApplicationDto> getApplicationsByStatus(int statusId) {
        ...
        return applicationRepository.findApplicationsByStatusId(statusId)
            .stream()
            .map(converter::toDto)
            .toList();
    }
